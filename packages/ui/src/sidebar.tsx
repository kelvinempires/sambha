    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-primary-darkPurple flex min-h-svh w-full",
            className
          )}
          {...props}
        >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-primary-darkPurple text-sidebar-foreground  p-0 [&>button]"
          side={side}
        >
          <div className="flex h-full w-full flex-col bg-primary-darkPurple text-sidebar-foreground">
            {children}
          </div>
        </SheetContent>
      </Sheet>
...
function SidebarTrigger({ onClick }: React.ComponentProps<typeof Button>) {
