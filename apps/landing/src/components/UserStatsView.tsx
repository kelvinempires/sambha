...
export const UserStatsView = ({
  ...
  const [copiedState, setCopiedState] = useState<"referral" | "stats" | null>(
    null
  );
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="text-center">
            ...
            <div className="text-text-muted text-sm">Position</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-text-muted text-sm">Points</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-text-muted text-sm">Referrals</div>
          </div>
